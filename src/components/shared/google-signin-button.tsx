...
export function GoogleSignInButton({ label = 'Continue with Google' }: Props) {
  ...
  return (
    <a
      ...
      className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-medium text-foreground hover:bg-accent transition-colors disabled:opacity-60"
