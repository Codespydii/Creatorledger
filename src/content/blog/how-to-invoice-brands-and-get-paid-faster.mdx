...
<figure>
  <img src="/blog/invoice-getting-paid.jpg" alt="A desk with a laptop, calculator and cash as someone works through payments" className="w-full rounded-xl border border-border" />
  <figcaption>Getting paid is its own job — track what's outstanding so earned money actually lands.</figcaption>
</figure>
